export default {
  ...
  study: {
    ...
    courseRelated: "Related files & projects",
    noCourseRelated: "No related files for this course yet",
    courseRelatedFailed: "Failed to load related files",
    aliases: "Aliases",
    aliasesHint: "Projects whose name or path contains an alias appear under this course",
    aliasesPlaceholder: "e.g. calculus, analysis",
  ...
  settings: {
    ...
    actionLogRecent: "Showing the most recent {{count}} entries",
    ...
    autoArchiveConfirmTitle: "Enable auto archive?",
    autoArchiveConfirmBody:
      "New files with a clear category will move into your Library automatically, without confirming each one. Files on another drive or in use stay in place with a failure notice. You can turn this off here at any time.",
    autoArchiveConfirmAction: "Enable anyway",
    confirmSave: "Confirm save",
    recommendedTitle: "Suggested locations (dedicated folders under your directories)",
    archiveGuardBlocked: "This location cannot be used as the Library",
    archiveGuardWarn: "A dedicated subfolder is recommended",
    guardReason_drive_root: "A drive root cannot be used.",
    guardReason_protected_tree: "System and program folders are protected; archiving into them is not allowed.",
    guardReason_appdata_tree: "Application data folders are protected; archiving into them is not allowed.",
    guardReason_user_profile: "Your whole user folder is too broad; pick a subfolder instead.",
    guardReason_user_core_dir: "This folder is in daily use; the Library would mix with everyday files.",
    guardReason_invalid_path: "The path is invalid.",
    guardReason_generic: "This location is not suitable.",
  ...
  files: {
    ...
    acKeywordCategory: "Filter by category",
    acKeywordType: "Filter by extension",
    acKeywordKind: "Filter by content kind",
    viewSwitchLabel: "Switch content view",
    ...
    projectEmptyTitle: "No projects yet",
    projectEmptyDesc:
      "Projects discovered under watched folders will appear here.",
    ...
    preflightLoading: "Collecting archive stats…",
    preflightSummary: "{{count}} items · {{size}}",
    preflightExecutables: "exe {{exe}} · dll {{dll}}",
    preflightSymlinks: "{{count}} symlinks",
    preflightShortcuts: "{{count}} shortcut(s) point into the selection and will break",
    preflightTruncated: "Large selection — stats cover the first 50,000 entries only",
    archiveSoftwareWarning:
      "{{names}} is detected as installed software; whole-tree moves may break it (alternatives: copy or archive as zip).",
    archiveRiskConfirm: "I understand the risk and still want to archive the whole tree",
  ...
  help: {
    ...
    onboardingIntro: "Four steps to get started:",
    ...
    onboardingStep3Title: "Choose the archive location",
    onboardingStep3Desc: "Pick a dedicated, low-stakes folder as your Library for organizing files; skippable.",
    onboardingStep4Title: "Meet the Projects page",
    onboardingStep4Desc: "Code and tool projects appear here for one-click opening or desktop shortcuts.",
    onboardingBack: "Back",
    onboardingNext: "Next",
    onboardingArchiveSkip: "Skip archiving for now",
    onboardingArchiveRequired: "Choose an archive location first (or pick “Skip archiving for now”).",
    onboardingArchiveUseWarn: "Use this location anyway",
    skip: "Skip",
    start: "Get started",
